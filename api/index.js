...
import {getOpenAIResponse} from './open_ai_service';
...
export const fetchUser = async (id = '60d0fe4f5311236168a109cc') => {
...
export const fetchFeedback = id => {
  return fetch(`${BASE_URL}/post/${id}/comment`, {
    method: 'GET',
    headers: HEADERS,
  })
    .then(responseHandler)
...
export const fetchRequests = type => {
  ...
  return fetch(`${BASE_URL}/user?page=${page}&limit=5`, {
    method: 'GET',
    headers: HEADERS,
  })
    .then(responseHandler)
